...
# -DCS_PLATFORM=CS_P_UNIX 
#-DMG_ENABLE_CALLBACK_USERDATA
#-DMG_ENABLE_HTTP_STREAMING_MULTIPART -DMG_MODULE_LINES -DMG_ENABLE_CALLBACK_USERDATA

# -DCS_PLATFORM=CS_P_UNIX

#include src/mg_modules.mk

CFLAGS   += -c -Wall -g -O0 -I$(APP_INC_DIR) $(MONGOOSE_FEATURES)
...
LDFLAGS += -lm -lstdc++ -lssl -lpthread
...
install:
	...
	install sender $(APP_OUT_DIR)/bin
#	install ./libaio/libaio.so $(APP_OUT_DIR)/lib
